/**
 * NXTG Design System — runtime tokens
 *
 * Lifted from prototype/mockup/DESIGN.md. Consumed by every *.mockup.tsx file.
 * Keep this in sync with DESIGN.md — do NOT introduce raw hex in mockup files.
 */
